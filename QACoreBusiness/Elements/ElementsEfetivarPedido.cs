...
{
    class ElementsEfetivarPedido : ElementsBasePedido
    {
        ...
        public IWebElement DataPrevista => ElementWait.WaitForElementXpath(chromeDriver, "//div[@class='ui large fluid input']//div[@class='floatlabel-wrapper']//input[@id='PedidoEntrega_DataPrevista'][@name='DataPrevista']");
        public IWebElement ValorEntrega => ElementWait.WaitForElementXpath(chromeDriver, "//div[@id='PedidoEntrega_Frete_auto_wrapper']//div[@class='ui large fluid input']//div[@class='floatlabel-wrapper']//input[@id='PedidoEntrega_Frete'][@name='Frete']");
        ...
        public IWebElement EditTextSKUProduto => ElementWait.WaitForElementXpath(chromeDriver, "//div[@id='pedido-edit-wrapper']//div[@class='ui form container']//div[@class='components']//div[@id='pedido-itens-wrapper']//div[@class='ui green segment']//div[@class='ui fields']//div[@class='four wide field']//div[@class='ui large input']//input[@name='sku']");
        public IWebElement EditTextNomeProduto => ElementWait.WaitForElementXpath(chromeDriver, "//div[@id='pedido-edit-wrapper']//div[@class='ui form container']//div[@class='components']//div[@id='pedido-itens-wrapper']//div[@class='ui green segment']//div[@class='ui fields']//div[@class='ui large input']//input[@name='nome']");
        public IWebElement EditTextQuantidadeItemPedido => ElementWait.WaitForElementXpath(chromeDriver, "//div[@id='pedido-itens-wrapper']//div[@class='ui green segment']//div[@class='ui stackable row three column grid']//div[@class='sixteen wide field']//div[@class='ui large action input']//input[@name='quantidade']");
        ...
        public IWebElement EditTextDescricaoNegociacao => ElementWait.WaitForElementXpath(chromeDriver, "//div[@id='NegociacaoParte_Descricao_auto_wrapper']//div[@class='ui large fluid input']//div[@class='floatlabel-wrapper']//input[@id='NegociacaoParte_Descricao']");
