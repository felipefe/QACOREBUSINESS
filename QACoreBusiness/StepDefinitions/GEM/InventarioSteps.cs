...
namespace QACoreBusiness.StepDefinitions.GEM
{
    ...
    public class InventarioSteps
    {
        ...
        [When(@"clique no botao voltar")]
        public void WhenCliqueNoBotaoVoltar()
        {
            ieu.CliqueBotaoVoltar();
        }
        ...
        [When(@"clique no botao criar produto")]
        public void WhenCliqueNoBotaoCriarProduto()
        {
